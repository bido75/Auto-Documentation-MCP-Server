...
const envKeys = [
  ...
  "AUTO_DOC_RUNNER_RELEASE_PROBE_BEFORE_PACKAGE",
  "AUTO_DOC_RUNNER_RELEASE_PROBE_MAX_FEATURES",
...
describe("parseContinuousRunnerTargets", () => {
  it("reads the single-target runner config from AUTO_DOC_RUNNER_* env vars", () => {
    setRunnerEnv({
      ...
      AUTO_DOC_RUNNER_RELEASE_PROBE_BEFORE_PACKAGE: "true",
      AUTO_DOC_RUNNER_RELEASE_PROBE_MAX_FEATURES: "12",
    ...
    expect(parseContinuousRunnerTargets()).toEqual([
      {
        ...
        releaseProbeBeforePackage: true,
        releaseProbeMaxFeatures: 12,
  ...
  it("reads multiple targets from AUTO_DOC_RUNNER_TARGETS JSON", () => {
    setRunnerEnv({
      ...
      AUTO_DOC_RUNNER_RELEASE_PROBE_BEFORE_PACKAGE: undefined,
      AUTO_DOC_RUNNER_RELEASE_PROBE_MAX_FEATURES: undefined,

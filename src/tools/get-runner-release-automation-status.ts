...
export function registerGetRunnerReleaseAutomationStatusTool(server: McpServer) {
  server.tool(
    "get_runner_release_automation_status",
    "Reports persisted runner release automation status for a project and repository target.",
    {

...
export function registerConfigureAiProviderTool(server: McpServer) {
  server.tool(
    "configure_ai_provider",
    "Set the AI model provider for documentation generation. Supports local Ollama, cloud Claude/GPT-4, Bifrost gateway, or deterministic mode.",
    {
      providerType: z.enum([
        "deterministic",
        "local-ollama",
